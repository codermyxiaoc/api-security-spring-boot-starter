...
import cn.coderxiaoc.exception.signature.SignatureGenerationException;
import cn.coderxiaoc.exception.signature.SignatureParamsEmptyException;
import cn.coderxiaoc.exception.signature.SignatureParamsParseException;
...
import cn.coderxiaoc.signature.ParamsParseAbstract;
...
@ControllerAdvice
@Log4j2
public class ResponseSignatureBeforeAdvisor extends ResponseSignatureAbstract<Object> implements Ordered {

    public ResponseSignatureBeforeAdvisor(ApplicationContext applicationContext, cn.coderxiaoc.signature.Signature signature) {
...
;
    ...
    public boolean supports(MethodParameter returnType, Class<? extends HttpMessageConverter<?>> converterType) {
        ...
        return isSupport && signatureAnnotation.runtimeType() == RuntimeType.BEFORE;
    }
}
